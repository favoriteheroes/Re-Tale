//=============================================================================
// BattleEffectRemove.js
//=============================================================================

/*:ja
 * @plugindesc ver1.00 戦闘エフェクト削除
 * @author 奏ねこま
 *
 * @help
 * 
 * https://tm.lucky-duet.com/viewtopic.php?t=3970
 *元ネタ
 *フェード時間は一番上にある「fadeDuration」の値で変更できます。
 *このプラグインに関しては、利用規約等は一切設けないので、ご自由にお使い下さい。
 * 
 * 
 * 
 * 
