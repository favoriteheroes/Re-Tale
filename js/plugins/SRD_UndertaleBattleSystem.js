...
Window_Bubble_Message.prototype.windowWidth = function() {
    return Graphics.boxWidth / 2.7;
      //return Graphics.boxWidth / 5;
};

Window_Bubble_Message.prototype.windowHeight = function () {         //���͑��݂��Ȃ������@�e������������R�R
    if ($gameMap.mapId() == 30 || $gameMap.mapId() == 46) {         //�z�b�g�P�[�L��Ƃ���ԑ��̓t�L�_�V�S�s��
...
Window_Bubble_Message.prototype.startPause = function() {
	this.startWait(60);     //�e�L�X�g�\���E�F�C�g,�f�t�H�l15
	this.pause = true;
};
