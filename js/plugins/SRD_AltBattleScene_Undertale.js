...
Scene_Battle.prototype.createAllWindows = function() {
	...
	this._actorCommandWindow.x = 48;    //�R�}���h�̃x�[�X�ʒu����

	//this._statusWindow.y = Graphics.boxHeight - this._actorCommandWindow.height - this._statusWindow.height;
	this._statusWindow.y = Graphics.boxHeight - this._actorCommandWindow.height - this._statusWindow.height + 10;       //��{���A���OHP�Q�[�W�ʒu����
    ...
    this._messageWindow.y = this._messageBox.y + 10;       //���b�Z�[�W�E�B���h�E����
...
Window_BattleEnemy.prototype.drawGauge = function(x, y, width, rate, color1, color2) {
    ...
    this.contents.fillRect(x+50, gaugeY, width, 18, this.gaugeBackColor());
    //this.contents.gradientFillRect(x, gaugeY, fillW, 18, color1, color2);
    this.contents.gradientFillRect(x+50, gaugeY, fillW, 18, color1, color2);
};
...
Window_ActorCommand.prototype._refreshCursor = function() {
	var pad = this._padding;
    //var x = this._cursorRect.x + pad - this.origin.x;
    var x = this._cursorRect.x + pad - this.origin.x + 7;      //�J�[�\��������
	var y = this._cursorRect.y + pad - this.origin.y;
	var w = this._cursorRect.width;
	var h = this._cursorRect.height;
	var m = 4;
...
Window_ActorCommand.prototype.windowWidth = function() {
    ...
    return Graphics.boxWidth - 100;     //�R�}���h������
};
...
Window_ActorCommand.prototype.drawItem = function(index) {
	if(_.images) {
	    ...
	    sprite.x = rect.x + (rect.width/2) + (this.textPadding()*2) + 9;       //�R�}���h�������i�N���b�N�ʒu���������j
...
Window_BattleItem.prototype.drawItemName = function(item, x, y, width) {
	...
	if (item) {
		...
		this.resetTextColor();
		if (this.needsNumber()) {
		    //this.drawText(item.name + "(" + $gameParty.numItems(item) + ")",            //�������I�@���ʏ������폜�A�A�C�e�����X�g��*��ǉ�
